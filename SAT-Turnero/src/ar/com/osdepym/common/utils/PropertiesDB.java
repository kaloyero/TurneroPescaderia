...
public class PropertiesDB {
	...
	public static final String KEY_IMPRESORA_CONECTADA = "IMPRESORA_CONECTADA";
	...
	public static boolean getImpresoraConectada() {
		boolean imprime = false;
		if (getPropertyValue(KEY_IMPRESORA_CONECTADA).equals("SI"))
			imprime = true;
